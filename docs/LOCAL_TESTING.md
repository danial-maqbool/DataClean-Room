...
An OCR miss is a failed automatic-redaction check even if a separately reviewed
manual mask succeeds. Read each result instead of treating a created file as proof.
